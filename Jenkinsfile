...
pipeline {
    parameters {
        ...
        string(name: 'DOCKER_IMAGE_NAME',          description: 'Docker Image Name',                    defaultValue: 'inpoin-product-purchasing-service')
                ...
                stage('Unit Test') {
                    ...
                    steps {
                        ...
                        script {
                            ...
                            def node = tool name: 'NodeJS-10.7', type: 'jenkins.plugins.nodejs.tools.NodeJSInstallation'
